...
const TONES = {
  ...
  light: {
    fallback:
      "radial-gradient(120% 90% at 10% 8%, #e8d4c8 0%, transparent 52%), radial-gradient(90% 70% at 88% 14%, #e3dacc 0%, transparent 48%), radial-gradient(80% 80% at 72% 88%, #d9cfc4 0%, transparent 52%), #faf9f5",
